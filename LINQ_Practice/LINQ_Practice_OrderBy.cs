...
namespace LINQ_Practice
{
         ...
         */
    {
        ...
        {
            var expected = PracticeData.OrderBy(c => { return c.Name; }).ToList();
        ...
        {
            var expected = PracticeData[0].Students.OrderBy(s => { return s.Birthday; }).ToList();
        ...
        {
            var expected = PracticeData[0].Students.OrderByDescending(s => { return s.Birthday; }).ToList(); 
        ...
        {
            var expected = PracticeData[2].JuniorInstructors.OrderBy(j => { return j.LastName; }).ToList();
