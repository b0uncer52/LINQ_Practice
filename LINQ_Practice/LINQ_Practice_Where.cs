...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_Where
    {
        ...
        {
            List<Cohort> ActualCohorts = PracticeData.Where(c => { return c.FullTime; }).ToList();
        ...
        {
            List<Cohort> ActualCohorts = PracticeData.Where(c => { return c.PrimaryInstructor.FirstName == "Jurnell"; }).ToList();
        ...
        {
            var ActualCohorts = PracticeData.Where(c => { return c.JuniorInstructors.Count == 3; }).ToList();
